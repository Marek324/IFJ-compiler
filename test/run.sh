...
TESTDIR=
COMPILER=./ifj24compiler # Path to the compiler binary
INTERPRETER=codegen_test/ic24int # Path to the interpreter binary
path_in=test/in # Input directory containing .ifj and .in* files
path_out=test/out # Output directory for generated files
path_ref=test/ref # Reference direcotry for .ref* and .exit* files
